...
export default function Priority() {
  ...
  const addProcess = () => {
    ...
    updatedProcesses = calculatePriority(updatedProcesses);
  ...
  const calculatePriority = (processes: Process[]): Process[] => {
  ...
  const getExecutionOrder = () => {
    ...
    const sortedProcesses = [...processes].sort((a, b) => 
      a.priority - b.priority || a.arrivalTime - b.arrivalTime || a.originalId - b.originalId);
  ...
  The process with the highest priority (usually the lowest number) is <br />executed first. 
  If two processes have the same priority, they are scheduled based on their arrival time.
            ...
            <Space size="middle" wrap>
              ...
              />
              <Input
                addonBefore={<span style={{ color: '#fff' }}>Priority</span>}
